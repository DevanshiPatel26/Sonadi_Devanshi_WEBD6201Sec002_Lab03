...
((core) =>
{
    ...
    function loadHeader(pageName)
    {
      ...
      {
        $("header").html(html_data); // load the navigation bar
    ...
    function toggleLogin()
    {
      ...
      // Add the Task List icon to the nav bar
      $(`<li class="nav-item">
        <a id="task-list" class="nav-link" aria-current="page"><i class="fa-brands fa-stack-exchange"></i> Task List</a>
      </li>`).insertBefore("#loginListItem");
      }
      else
      {
    ...
    function ActiveLinkCallBack(activeLink)
    {
      switch (activeLink) 
      {
        ...
        // Add DisplayTaskList to the CallBack function
    ...
    */
    function AddNewTask() 
    {
      ...
      if (taskInput.val() != "" && taskInput.val().charAt(0) != " ") 
      {
        ...
        // if it is not empty
        // declare a variable and get the value from the textbox id
        let newElement = `
    ...
    function DisplayTaskList()
    {
      // declare a variable
        ...
        // add a new Task to the Task List when user press add button
        $("#newTaskButton").on("click", function()
        {       
          // call the AddNewTask() function  
            AddNewTask();
        });

        // Add a new task to the tasklist when user press Enter key
